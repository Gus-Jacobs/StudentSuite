...
class CareerScreen extends StatelessWidget {
  static const List<_CareerTool> tools = [
    _CareerTool('Resume Builder', Icons.description_outlined, '/resume',
        isPro: true),
    _CareerTool('Cover Letter', Icons.edit_note_outlined, '/cover_letter',
        isPro: true),
    _CareerTool('Interview Tips', Icons.lightbulb_outline, '/interview_tips',
        isPro: false),
    _CareerTool('AI Interviewer', Icons.smart_toy_outlined, '/ai_interviewer',
        isPro: true),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _CareerToolCard(tool: tool);
      },
    );
  }
}
...
class _CareerToolCard extends StatelessWidget {
  const _CareerToolCard({required this.tool});

  final _CareerTool tool;
...
class _CareerTool {
  ...
  const _CareerTool(this.name, this.icon, this.route, {this.isPro = false});
}
